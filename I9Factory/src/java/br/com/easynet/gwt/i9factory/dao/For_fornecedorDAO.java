...
public class For_fornecedorDAO extends ObjectDAO {
    ...
    public void insert(For_fornecedorT for_fornecedorT) throws Exception {
        ...
        try {
            String sql = "insert into factory.for_fornecedor ( for_tx_nome, for_tx_endereco, for_tx_cpf_cnpj, for_tx_rg_inscricao, for_tx_cep, for_tx_cidade, for_tx_estado, for_tx_bairro, for_tx_email, for_tx_home_page, for_tx_contato, for_tx_status,for_tx_telefone1,for_tx_telefone2) values ( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? ,?,?)";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, for_fornecedorT.getFor_tx_nome());
            pStmt.setObject(2, for_fornecedorT.getFor_tx_endereco());
            pStmt.setObject(3, for_fornecedorT.getFor_tx_cpf_cnpj());
            pStmt.setObject(4, for_fornecedorT.getFor_tx_rg_inscricao());
            pStmt.setObject(5, for_fornecedorT.getFor_tx_cep());
            pStmt.setObject(6, for_fornecedorT.getFor_tx_cidade());
            pStmt.setObject(7, for_fornecedorT.getFor_tx_estado());
            pStmt.setObject(8, for_fornecedorT.getFor_tx_bairro());
            pStmt.setObject(9, for_fornecedorT.getFor_tx_email());
            pStmt.setObject(10, for_fornecedorT.getFor_tx_home_page());
            pStmt.setObject(11, for_fornecedorT.getFor_tx_contato());
            pStmt.setObject(12, for_fornecedorT.getFor_tx_status());
            pStmt.setObject(13, for_fornecedorT.getFor_tx_telefone1());
            pStmt.setObject(14, for_fornecedorT.getFor_tx_telefone2());
            pStmt.execute();
        } catch (Exception e) {
            throw e;
        } finally {
    ...
    public void update(For_fornecedorT for_fornecedorT) throws Exception {
        PreparedStatement pStmt = null;
        try {
            String sql = "update factory.for_fornecedor set  for_tx_nome=?, for_tx_endereco=?, for_tx_cpf_cnpj=?, for_tx_rg_inscricao=?, for_tx_cep=?, for_tx_cidade=?, for_tx_estado=?, for_tx_bairro=?, for_tx_email=?, for_tx_home_page=?, for_tx_contato=?, for_tx_status=?,for_tx_telefone1=?,for_tx_telefone2=?  where  for_nr_id=?";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, for_fornecedorT.getFor_tx_nome());
            pStmt.setObject(2, for_fornecedorT.getFor_tx_endereco());
            pStmt.setObject(3, for_fornecedorT.getFor_tx_cpf_cnpj());
            ...
            pStmt.setObject(13, for_fornecedorT.getFor_tx_telefone1());
            pStmt.setObject(14, for_fornecedorT.getFor_tx_telefone2());
            pStmt.setObject(15, for_fornecedorT.getFor_nr_id());
            pStmt.execute();
        } catch (Exception e) {
            throw e;
        } finally {
    ...
    public void delete(For_fornecedorT for_fornecedorT) throws Exception {
        PreparedStatement pStmt = null;
        try {
            String sql = "delete from factory.for_fornecedor where  for_nr_id=?";
            pStmt = con.prepareStatement(sql);
    ...
    private List<For_fornecedorT> resultSetToObjectTransfer(ResultSet rs) throws Exception {
        ...
        while (rs.next()) {
            ...
            for_fornecedorT.setFor_tx_telefone1(rs.getString("for_tx_telefone1"));
            for_fornecedorT.setFor_tx_telefone2(rs.getString("for_tx_telefone1"));
    ...
    public List<For_fornecedorT> getAll() throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from factory.for_fornecedor";
            pStmt = con.prepareStatement(sql);
    ...
    public List<For_fornecedorT> getByPK(For_fornecedorT for_fornecedorT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from factory.for_fornecedor where  for_nr_id=?";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, for_fornecedorT.getFor_nr_id());
            rs = pStmt.executeQuery();
    ...
    public List<For_fornecedorT> getByFor_tx_nome(For_fornecedorT for_fornecedorT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from factory.for_fornecedor where  Upper(for_tx_nome) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
            pStmt.setObject(1, '%' + for_fornecedorT.getFor_tx_nome() + '%');
            rs = pStmt.executeQuery();
            return resultSetToObjectTransfer(rs);
    ...
    public List<For_fornecedorT> getByFor_tx_endereco(For_fornecedorT for_fornecedorT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from factory.for_fornecedor where  Upper(for_tx_endereco) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<For_fornecedorT> getByFor_tx_cpf_cnpj(For_fornecedorT for_fornecedorT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from factory.for_fornecedor where  Upper(for_tx_cpf_cnpj) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<For_fornecedorT> getByFor_tx_rg_inscricao(For_fornecedorT for_fornecedorT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from factory.for_fornecedor where  Upper(for_tx_rg_inscricao) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<For_fornecedorT> getByFor_tx_cep(For_fornecedorT for_fornecedorT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from factory.for_fornecedor where  for_tx_cep = ? ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<For_fornecedorT> getByFor_tx_cidade(For_fornecedorT for_fornecedorT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from factory.for_fornecedor where  Upper(for_tx_cidade) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<For_fornecedorT> getByFor_tx_estado(For_fornecedorT for_fornecedorT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from factory.for_fornecedor where  Upper(for_tx_estado) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<For_fornecedorT> getByFor_tx_bairro(For_fornecedorT for_fornecedorT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from factory.for_fornecedor where  Upper(for_tx_bairro) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<For_fornecedorT> getByFor_tx_email(For_fornecedorT for_fornecedorT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from factory.for_fornecedor where  Upper(for_tx_email) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<For_fornecedorT> getByFor_tx_home_page(For_fornecedorT for_fornecedorT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from factory.for_fornecedor where  Upper(for_tx_home_page) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<For_fornecedorT> getByFor_tx_contato(For_fornecedorT for_fornecedorT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from factory.for_fornecedor where  Upper(for_tx_contato) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
    ...
    public List<For_fornecedorT> getByFor_tx_status(For_fornecedorT for_fornecedorT) throws Exception {
        ...
        ResultSet rs = null;
        try {
            String sql = "select * from factory.for_fornecedor where  Upper(for_tx_status) like Upper(?) ";
            pStmt = con.prepareStatement(sql);
