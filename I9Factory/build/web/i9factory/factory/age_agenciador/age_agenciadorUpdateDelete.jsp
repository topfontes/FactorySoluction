...
<form name="age_agenciador" action="portal.jsp" method="post"   >                                         
    ...
    <input type="hidden" name="urlCanal" value="/i9factory/factory/age_agenciador/age_agenciadorUpdateDelete.jsp"/>
<!-- Titulo da Operacao-->
...
<table width="600" align="left" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    		<input type="button" value="Alterar" class="ms-ButtonHeightWidth" onClick="setOpPortal('age_agenciador', 'update' , '/i9factory/factory/age_agenciador/age_agenciadorUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Excluir" class="ms-ButtonHeightWidth" onClick="setOpPortal('age_agenciador', 'delete' , '/i9factory/factory/age_agenciador/age_agenciadorUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
		<input type="button" value="Voltar" class="ms-ButtonHeightWidth" onClick="setOpPortal('age_agenciador', 'consult', '/i9factory/factory/age_agenciador/age_agenciadorConsult.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<!--input type="button" value="Cancel" class="ms-ButtonHeightWidth"  onClick="setOpPortal('age_agenciador', 'consult' , '/i9factory/factory/age_agenciador/age_agenciadorConsult.jsp')" /-->
...
<br/>
	...
	<td class="ms-standardheader">
		age_nr_id:<span class="style1">*</span>
	</td>
	<td class="ms-fields">
		<label class="ms-standardheader">
  		  <input type="text" name="age_agenciadorT.age_nr_id" value="${age_agenciadorJB.age_agenciadorT.age_nr_id}" onKeyPress="nextField(this, event)"/> 
   	       </label>
	</td>
     </tr>
     <tr>
