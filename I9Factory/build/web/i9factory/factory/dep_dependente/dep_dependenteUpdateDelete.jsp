...
<form name="dep_dependente" action="portal.jsp" method="post"   >                                         
    ...
    <input type="hidden" name="urlCanal" value="/i9factory/factory/dep_dependente/dep_dependenteUpdateDelete.jsp"/>
<!-- Titulo da Operacao-->
...
<table width="600" align="left" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    		<input type="button" value="Alterar" class="ms-ButtonHeightWidth" onClick="setOpPortal('dep_dependente', 'update' , '/i9factory/factory/dep_dependente/dep_dependenteUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Excluir" class="ms-ButtonHeightWidth" onClick="setOpPortal('dep_dependente', 'delete' , '/i9factory/factory/dep_dependente/dep_dependenteUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
		<input type="button" value="Voltar" class="ms-ButtonHeightWidth" onClick="setOpPortal('dep_dependente', 'consult', '/i9factory/factory/dep_dependente/dep_dependenteConsult.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<!--input type="button" value="Cancel" class="ms-ButtonHeightWidth"  onClick="setOpPortal('dep_dependente', 'consult' , '/i9factory/factory/dep_dependente/dep_dependenteConsult.jsp')" /-->
...
<br/>
	...
	<td class="ms-standardheader">
		dep_nr_id:<span class="style1">*</span>
	</td>
	<td class="ms-fields">
		<label class="ms-standardheader">
  		  <input type="text" name="dep_dependenteT.dep_nr_id" value="${dep_dependenteJB.dep_dependenteT.dep_nr_id}" onKeyPress="nextField(this, event)"/> 
   	       </label>
	</td>
     </tr>
<tr>
