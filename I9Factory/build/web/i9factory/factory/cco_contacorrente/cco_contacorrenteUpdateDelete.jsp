...
<form name="cco_contacorrente" action="portal.jsp" method="post" enctype="multipart/form-data" >                                         
    ...
    <input type="hidden" name="urlCanal" value="/i9factory/factory/cco_contacorrente/cco_contacorrenteUpdateDelete.jsp"/>
<!-- Titulo da Operacao-->
...
<table width="600" align="left" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    		<input type="button" value="Alterar" class="ms-ButtonHeightWidth" onClick="setOpPortal('cco_contacorrente', 'update' , '/i9factory/factory/cco_contacorrente/cco_contacorrenteUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Excluir" class="ms-ButtonHeightWidth" onClick="setOpPortal('cco_contacorrente', 'delete' , '/i9factory/factory/cco_contacorrente/cco_contacorrenteUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
		<input type="button" value="Voltar" class="ms-ButtonHeightWidth" onClick="setOpPortal('cco_contacorrente', 'consult', '/i9factory/factory/cco_contacorrente/cco_contacorrenteConsult.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<!--input type="button" value="Cancel" class="ms-ButtonHeightWidth"  onClick="setOpPortal('cco_contacorrente', 'consult' , '/i9factory/factory/cco_contacorrente/cco_contacorrenteConsult.jsp')" /-->
...
<br/>
	...
	<td class="ms-standardheader">
		cco_nr_id:<span class="style1">*</span>
	</td>
	<td class="ms-fields">
		<label class="ms-standardheader">
  		  <input type="text" name="cco_contacorrenteT.cco_nr_id" value="${cco_contacorrenteJB.cco_contacorrenteT.cco_nr_id}" onKeyPress="nextField(this, event)"/> 
   	       </label>
	</td>
     </tr>
     <tr>
