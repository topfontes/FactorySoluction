...
<form name="vw_parcelas" action="portal.jsp" method="post"   >                                         
    ...
    <input type="hidden" name="urlCanal" value="/i9factory/factory/vw_parcelas/vw_parcelasUpdateDelete.jsp"/>
<!-- Titulo da Operacao-->
...
<table width="600" align="left" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    		<input type="button" value="Alterar" class="ms-ButtonHeightWidth" onClick="setOpPortal('vw_parcelas', 'update' , '/i9factory/factory/vw_parcelas/vw_parcelasUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Excluir" class="ms-ButtonHeightWidth" onClick="setOpPortal('vw_parcelas', 'delete' , '/i9factory/factory/vw_parcelas/vw_parcelasUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
		<input type="button" value="Voltar" class="ms-ButtonHeightWidth" onClick="setOpPortal('vw_parcelas', 'consult', '/i9factory/factory/vw_parcelas/vw_parcelasConsult.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<!--input type="button" value="Cancel" class="ms-ButtonHeightWidth"  onClick="setOpPortal('vw_parcelas', 'consult' , '/i9factory/factory/vw_parcelas/vw_parcelasConsult.jsp')" /-->
