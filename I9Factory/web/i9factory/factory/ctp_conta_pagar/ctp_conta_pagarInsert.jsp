...
<form name="ctp_conta_pagar" action="portal.jsp" method="post"   > 
    ...
    <input type="hidden" name="urlCanal" value="/i9factory/factory/ctp_conta_pagar/ctp_conta_pagarInsert.jsp"/>
...
<table align="left" width="600" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    			    <input type="button" class="ms-ButtonHeightWidth" value="Cadastrar"  onClick="setOpPortal('ctp_conta_pagar','insert', '/i9factory/factory/ctp_conta_pagar/ctp_conta_pagarInsert.jsp')" /> &nbsp;&nbsp;
    			    <!--input type="reset"  value="Clear" onclick="setOpPortal('ctp_conta_pagar','Limpar', '/i9factory/factory/ctp_conta_pagar/ctp_conta_pagarInsert.jsp')"/-->&nbsp;&nbsp;
    			    <input type="button" class="ms-ButtonHeightWidth" value="Voltar"  onClick="setOpPortal('ctp_conta_pagar','', '/i9factory/factory/ctp_conta_pagar/ctp_conta_pagarConsult.jsp')" />
    </div></td>
  </tr>
</table>
<br/>
