...
<jsp:useBean id="emp_emprestimoJB" class="br.com.easynet.gwt.i9factory.jb.Emp_emprestimoUpdateDeleteJB" scope="request"/>                                         
...
<form name="emp_emprestimo" action="portal.jsp" method="post"   >                                         
    ...
    <input type="hidden" name="urlCanal" value="/i9factory/factory/emp_emprestimo/emp_emprestimoUpdateDelete.jsp"/>
<!-- Titulo da Operacao-->
...
<table width="600" align="left" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    		<input type="button" value="Alterar" class="ms-ButtonHeightWidth" onClick="setOpPortal('emp_emprestimo', 'update' , '/i9factory/factory/emp_emprestimo/emp_emprestimoUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Excluir" class="ms-ButtonHeightWidth" onClick="setOpPortal('emp_emprestimo', 'delete' , '/i9factory/factory/emp_emprestimo/emp_emprestimoUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
		<input type="button" value="Voltar" class="ms-ButtonHeightWidth" onClick="setOpPortal('emp_emprestimo', 'consult', '/i9factory/factory/emp_emprestimo/emp_emprestimoConsult.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<!--input type="button" value="Cancel" class="ms-ButtonHeightWidth"  onClick="setOpPortal('emp_emprestimo', 'consult' , '/i9factory/factory/emp_emprestimo/emp_emprestimoConsult.jsp')" /-->
...
<br/>
	...
	<td class="ms-fields">
		<label class="ms-standardheader">
  		  <input type="text" name="emp_emprestimoT.emp_nr_id" value="${emp_emprestimoJB.emp_emprestimoT.emp_nr_id}" onKeyPress="nextField(this, event)"/> 
   	       </label>
	</td>
     </tr>
<tr>
