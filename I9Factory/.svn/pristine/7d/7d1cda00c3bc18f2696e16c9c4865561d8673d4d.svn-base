...
<jsp:useBean id="ref_referenciaJB" class="br.com.easynet.gwt.i9factory.jb.Ref_referenciaUpdateDeleteJB" scope="request"/>                                         
...
<form name="ref_referencia" action="portal.jsp" method="post"   >                                         
    ...
    <input type="hidden" name="urlCanal" value="/i9factory/factory/ref_referencia/ref_referenciaUpdateDelete.jsp"/>
<!-- Titulo da Operacao-->
...
<table width="600" align="left" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    		<input type="button" value="Alterar" class="ms-ButtonHeightWidth" onClick="setOpPortal('ref_referencia', 'update' , '/i9factory/factory/ref_referencia/ref_referenciaUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Excluir" class="ms-ButtonHeightWidth" onClick="setOpPortal('ref_referencia', 'delete' , '/i9factory/factory/ref_referencia/ref_referenciaUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
		<input type="button" value="Voltar" class="ms-ButtonHeightWidth" onClick="setOpPortal('ref_referencia', 'consult', '/i9factory/factory/ref_referencia/ref_referenciaConsult.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<!--input type="button" value="Cancel" class="ms-ButtonHeightWidth"  onClick="setOpPortal('ref_referencia', 'consult' , '/i9factory/factory/ref_referencia/ref_referenciaConsult.jsp')" /-->
...
<br/>
	...
	<td class="ms-standardheader">
		ref_nr_id:<span class="style1">*</span>
	</td>
	<td class="ms-fields">
		<label class="ms-standardheader">
  		  <input type="text" name="ref_referenciaT.ref_nr_id" value="${ref_referenciaJB.ref_referenciaT.ref_nr_id}" onKeyPress="nextField(this, event)"/> 
   	       </label>
	</td>
     </tr>
<tr>
