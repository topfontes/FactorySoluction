...
<form name="org_orgao" action="portal.jsp" method="post"   > 
    ...
    <input type="hidden" name="urlCanal" value="/i9factory/factory/org_orgao/org_orgaoInsert.jsp"/>
...
<table align="left" width="600" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    			    <input type="button" class="ms-ButtonHeightWidth" value="Cadastrar"  onClick="setOpPortal('org_orgao','insert', '/i9factory/factory/org_orgao/org_orgaoInsert.jsp')" /> &nbsp;&nbsp;
    			    <!--input type="reset"  value="Clear" onclick="setOpPortal('org_orgao','Limpar', '/i9factory/factory/org_orgao/org_orgaoInsert.jsp')"/-->&nbsp;&nbsp;
    			    <input type="button" class="ms-ButtonHeightWidth" value="Voltar"  onClick="setOpPortal('org_orgao','', '/i9factory/factory/org_orgao/org_orgaoConsult.jsp')" />
    </div></td>
  </tr>
</table>
<br/>
