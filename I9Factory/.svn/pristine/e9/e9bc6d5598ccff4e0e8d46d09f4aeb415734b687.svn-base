...
<form name="for_fornecedor" action="portal.jsp" method="post"   >                                         
    ...
    <input type="hidden" name="urlCanal" value="/i9factory/factory/for_fornecedor/for_fornecedorUpdateDelete.jsp"/>
<!-- Titulo da Operacao-->
...
<table width="600" align="left" height="40" border="0" cellpadding="0" cellspacing="0">
  <tr >
    <td><div align="right">
    		<input type="button" value="Alterar" class="ms-ButtonHeightWidth" onClick="setOpPortal('for_fornecedor', 'update' , '/i9factory/factory/for_fornecedor/for_fornecedorUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<input type="button" value="Excluir" class="ms-ButtonHeightWidth" onClick="setOpPortal('for_fornecedor', 'delete' , '/i9factory/factory/for_fornecedor/for_fornecedorUpdateDelete.jsp')"/>&nbsp;&nbsp;&nbsp;
		<input type="button" value="Voltar" class="ms-ButtonHeightWidth" onClick="setOpPortal('for_fornecedor', 'consult', '/i9factory/factory/for_fornecedor/for_fornecedorConsult.jsp')"/>&nbsp;&nbsp;&nbsp;
    		<!--input type="button" value="Cancel" class="ms-ButtonHeightWidth"  onClick="setOpPortal('for_fornecedor', 'consult' , '/i9factory/factory/for_fornecedor/for_fornecedorConsult.jsp')" /-->
...
<br/>
	...
	<td class="ms-standardheader">
		for_nr_id:<span class="style1">*</span>
	</td>
	<td class="ms-fields">
