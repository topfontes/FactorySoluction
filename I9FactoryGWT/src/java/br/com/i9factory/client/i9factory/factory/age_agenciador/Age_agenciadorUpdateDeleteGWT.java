 ...
 * @author geoleite
 */
public class Age_agenciadorUpdateDeleteGWT extends AlterarExcluirBaseGWT {
    ...
    public Age_agenciadorUpdateDeleteGWT() {
        this.setSize("570", "540");
        this.setHeading("Alterar Agênciador");
    ...
    public void addComboEquipe() {
        ...
        if (age_agenciadorT.getEqp_nr_id() > 0) {
            comboequipe.setValue(eqp_equipeDAOGWT.getTree().get(age_agenciadorT.getEqp_nr_id()));
        }
    }
    ...
    public void addComboTipoLogradouro() {
        ...
        if (age_agenciadorT.getAge_tx_tipologradouro().trim().length() > 0) {
            comboTipoLogradouro.setValue(listTipoLogradouroGWT.getTree().get(age_agenciadorT.getAge_tx_tipologradouro()));
        }
    }

    public void load(Age_agenciadorTGWT age_agenciadorT) {
        this.age_agenciadorT = age_agenciadorT;
        age_nr_id.setValue(age_agenciadorT.getAge_nr_id() + "");
        age_tx_cpf.setValue(age_agenciadorT.getAge_tx_cpf());
        age_tx_nome.setValue(age_agenciadorT.getAge_tx_nome());
        age_dt_cadastro.setValue(age_agenciadorT.getAge_dt_cadastro());
        age_dt_nascimento.setValue(age_agenciadorT.getAge_dt_nascimento());
        eqp_nr_id.setValue(age_agenciadorT.getEqp_nr_id() + "");
        age_tx_tipologradouro.setValue(age_agenciadorT.getAge_tx_tipologradouro());
        age_tx_logradouro.setValue(age_agenciadorT.getAge_tx_logradouro());
        age_tx_numero.setValue(age_agenciadorT.getAge_tx_numero());
        age_tx_cep.setValue(age_agenciadorT.getAge_tx_cep());
        age_tx_complemento.setValue(age_agenciadorT.getAge_tx_complemento());
        age_tx_bairro.setValue(age_agenciadorT.getAge_tx_bairro());
        age_tx_municipio.setValue(age_agenciadorT.getAge_tx_municipio());
        age_tx_uf.setValue(age_agenciadorT.getAge_tx_uf());
        age_tx_telefone2.setValue(age_agenciadorT.getAge_tx_telefone2());
        age_tx_telefone2_1.setValue(age_agenciadorT.getAge_tx_telefone2_1());
        age_tx_celular.setValue(age_agenciadorT.getAge_tx_celular());
        age_tx_email.setValue(age_agenciadorT.getAge_tx_email());
        age_nr_taxaemprestimo.setValue(age_agenciadorT.getAge_nr_taxaemprestimo());
        age_nr_taxamensalidade.setValue(age_agenciadorT.getAge_nr_taxamensalidade());

        comboTipoLogradouro.setValue(listTipoLogradouroGWT.getTree().get(age_agenciadorT.getAge_tx_tipologradouro()));
        comboUF.setValue(listUF.getTreeUF().get(age_agenciadorT.getAge_tx_uf()));
        comboequipe.setValue(eqp_equipeDAOGWT.getTree().get(age_agenciadorT.getEqp_nr_id()));
    }
    ...
    public void btnUpdateAction(ButtonEvent ce) {
        ...
        if (msg.trim().length() > 0) {
            ...
            age_agenciadorT.setAge_nr_id(Integer.parseInt(age_nr_id.getValue()));
            ...
            age_agenciadorDao.alterar(age_agenciadorT);
            Timer timer = new Timer() {
    ...
    public void btnDeltAction(ButtonEvent ce) {
        ...
        age_agenciadorDao.excluir(age_agenciadorT);
        Timer timer = new Timer() {
