 ...
 * @author geoleite
 */
public class Org_orgaoUpdateDeleteGWT extends AlterarExcluirBaseGWT {
    ...
    public Org_orgaoUpdateDeleteGWT() {
    ...
    public void load(Org_orgaoTGWT org_orgaoT) {
        this.org_orgaoT = org_orgaoT;
        org_nr_id.setValue(org_orgaoT.getOrg_nr_id() + "");
        org_tx_cnpj.setValue(org_orgaoT.getOrg_tx_cnpj());
        org_tx_razaosocial.setValue(org_orgaoT.getOrg_tx_razaosocial());
        org_tx_nomefantasia.setValue(org_orgaoT.getOrg_tx_nomefantasia());
        org_tx_inscestadual.setValue(org_orgaoT.getOrg_tx_inscestadual());
        org_tx_tipologradouro.setValue(org_orgaoT.getOrg_tx_tipologradouro());
        org_tx_logradouro.setValue(org_orgaoT.getOrg_tx_logradouro());
        org_tx_numero.setValue(org_orgaoT.getOrg_tx_numero());
        org_tx_cep.setValue(org_orgaoT.getOrg_tx_cep());
        org_tx_complemento.setValue(org_orgaoT.getOrg_tx_complemento());
        org_tx_bairro.setValue(org_orgaoT.getOrg_tx_bairro());
        org_tx_municipio.setValue(org_orgaoT.getOrg_tx_municipio());
        org_tx_uf.setValue(org_orgaoT.getOrg_tx_uf());
        org_tx_telefone1.setValue(org_orgaoT.getOrg_tx_telefone1());
        org_tx_telefone2.setValue(org_orgaoT.getOrg_tx_telefone2());

        comboUF.setValue(listUF.getTreeUF().get(org_orgaoT.getOrg_tx_uf()));
        comboTipoLogradouro.setValue(listTipoLogradouroGWT.getTree().get(org_orgaoT.getOrg_tx_tipologradouro()));
    ...
    public void btnUpdateAction(ButtonEvent ce) {
        ...
        if (msg.trim().length() > 0) {
            ...
            org_orgaoT.setOrg_nr_id(Integer.parseInt(org_nr_id.getValue()));
            ...
            org_orgaoDao.alterar(org_orgaoT);
    ...
    public void btnDeltAction(ButtonEvent ce) {
        ...
        org_orgaoDao.excluir(org_orgaoT);
        Timer timer = new Timer() {
