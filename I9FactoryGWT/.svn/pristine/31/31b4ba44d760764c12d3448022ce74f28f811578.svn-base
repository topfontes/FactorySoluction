 ...
 * @author geoleite
 */
public class Vw_arquivo_retorno_bancoInsertGWT extends CadastrarBaseGWT  {
    ...
    public Vw_arquivo_retorno_bancoInsertGWT() {
	...
	Vw_arquivo_retorno_bancoTGWT vw_arquivo_retorno_bancoT = new Vw_arquivo_retorno_bancoTGWT();
        ...
        vw_arquivo_retorno_bancoDao.inserir(vw_arquivo_retorno_bancoT);
