 ...
 * @author geoleite
 */
public class Idc_indiceUpdateDeleteGWT extends AlterarExcluirBaseGWT {
    ...
    public Idc_indiceUpdateDeleteGWT() {
        this.setSize("250", "200");
        this.setHeading("Alteração de Indíces");
    ...
    public void load(Idc_indiceTGWT idc_indiceT) {
        this.idc_indiceT = idc_indiceT;
        idc_nr_id.setValue(idc_indiceT.getIdc_nr_id() + "");
        idc_nr_diainicial.setValue(idc_indiceT.getIdc_nr_diainicial());
        idc_nr_diafinal.setValue(idc_indiceT.getIdc_nr_diafinal());
        idc_nr_qtdparcelas.setValue(idc_indiceT.getIdc_nr_qtdparcelas());
        idc_nr_valor.setValue(idc_indiceT.getIdc_nr_valor());
    ...
    public boolean valido() {
        ...
        if (dia_inicio > dia_fim) {
            ...
            for (Idc_indiceTGWT idc_indiceTGWT : list.getModels()) {
                if (idc_indiceTGWT.getIdc_nr_id() != this.idc_indiceT.getIdc_nr_id()) {
    ...
    public void btnUpdateAction(ButtonEvent ce) {
        ...
        if (msg.trim().length() > 0) {
            ...
            if (valido()) {
                idc_indiceT.setIdc_nr_id(Integer.parseInt(idc_nr_id.getValue()));
                ...
                idc_indiceDao.alterar(idc_indiceT);
    ...
    public void btnDeltAction(ButtonEvent ce) {
        ...
        idc_indiceDao.excluir(idc_indiceT);
        Timer timer = new Timer() {
